...
nav2_util::CallbackReturn CollisionDetector::on_configure(const rclcpp_lifecycle::State & state)
{
...
nav2_util::CallbackReturn CollisionDetector::on_activate(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  timer_ = this->create_timer(
    std::chrono::duration<double>{1.0 / frequency_}, std::bind(&CollisionDetector::process, this));
...
nav2_util::CallbackReturn CollisionDetector::on_deactivate(
...
nav2_util::CallbackReturn CollisionDetector::on_cleanup(const rclcpp_lifecycle::State & /*state*/)
{
...
nav2_util::CallbackReturn CollisionDetector::on_shutdown(const rclcpp_lifecycle::State & /*state*/)
{
...
bool CollisionDetector::getParameters()
{
  ...
  nav2_util::declare_parameter_if_not_declared(node, "frequency", rclcpp::ParameterValue(10.0));
...
void CollisionDetector::process()
{
  ...
  for (std::shared_ptr<Polygon> polygon : polygons_) {
    ...
    state_msg->detections.push_back(
      polygon->getPointsInside(collision_points) >= polygon->getMinPoints());
  }
