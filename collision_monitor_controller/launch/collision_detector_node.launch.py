...
def generate_launch_description():
    # Environment
    package_dir = get_package_share_directory("collision_monitor_controller")
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                package="collision_monitor_controller",
        ...
        actions=[
            ...
            LoadComposableNodes(
                ...
                composable_node_descriptions=[
                    ...
                    ComposableNode(
                        package="collision_monitor_controller",
                        plugin="collision_monitor_controller::CollisionDetector",
